...
class TestPersianCalendar: UIViewController {
    ...
    func handleCellSelected(cell: JTAppleDayCell?, cellState: CellState){
    ...
    func handleCellTextColor(cell: JTAppleDayCell?, cellState: CellState){
        guard let validCell = cell as? CalendarCell else { return }
        if cellState.isSelected {
...
extension TestPersianCalendar: JTAppleCalendarMonthViewDataSource {
...
class CalendarCell: JTAppleDayCell {
